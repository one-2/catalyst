...
- The [architecture review](ARCHITECTURE_REVIEW) for a spotlight on the main features of each module, and the [system diagrams](https://www.figma.com/design/UXEFP7oxLK4gug4gUgBLbK/Catalyst-Working-Class-Diagram) for an overview of the system architecture;
- The [branch guide](docs/BRANCH_GUIDE.pdf) for what's on each of the dev branches.
